      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {INDUSTRIES.map((industry, index) => {
            ...
            const cardClasses = "bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 group flex flex-col items-start h-full";

            if (industry.href) {
              return (
                <Link key={index} to={industry.href} className={cardClasses}>
                  {CardContent}
                </Link>
              );
            }
